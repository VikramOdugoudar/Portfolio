				...
				<Row>
					<Col md={8} className="home-about-description">
						...
						<p className="home-about-body">
							I fell in love with{" "}
							<b className="purple">Javascript </b> and ever since
							i live on the adrenaline rush of developing things!
							😁💻
							<br />
							...
							<i>
								<b className="purple">
									Web Products, Games and Decentralized Apps.{" "}
								</b>{" "}
							</i>
							<br />
							<br />
							...
							<i>
								<b className="purple">
									{" "}
									So do add me on Xbox ID: wittygamer32
									{"     "}
								</b>
								<img
									src="https://emoji.gg/assets/emoji/3139_Xbox.png"
									width="25px"
									height="25px"
									alt="Xbox"
								></img>
